  ...
  FRETURES_EN: [
    {
      ...
      description: "Supports analysis of multiple types of data on air quality.",
    },
    {
      icon: IoCloudUpload,
      title: "Easy Upload",
      description: "Supports download and upload of internal data without complicated operations.",
    },
    {
      icon: IoAnalytics,
  ...
  FRETURES_ZH: [
    {
      icon: MdAir,
      title: "多源数据支持",
      description: "支持空气质量多种类型数据的分析。",
    },
    {
      icon: IoCloudUpload,
      title: "便捷上传",
      description: "支持内部数据下载后上传，无需复杂操作。",
    },
    {
      icon: IoAnalytics,
      title: "数据可视化",
      description: "可对数据进行图表分析，直观展示空气质量趋势变化。",
    },
    {
      icon: IoMap,
      title: "地理分布分析",
